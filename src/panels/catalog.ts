...
export const panelCatalog: PanelMeta[] = [
  ...
  { type: "chart", name: "Chart", description: "Daily line chart for one instrument with crosshair and range picker.", category: "markets", mnemonic: "GP", defaultSize: { w: 5, h: 6 }, minSize: { w: 3, h: 4 } },
  ...
  { type: "plot", name: "Plot", description: "A schematic chokepoint plot: lanes, transits and a datum. The CIC view.", category: "geo", mnemonic: "PLOT", defaultSize: { w: 5, h: 7 }, minSize: { w: 3, h: 4 } },
