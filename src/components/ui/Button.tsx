...
const base =
  "inline-flex items-center justify-center gap-1.5 rounded-[var(--radius)] font-ui font-medium whitespace-nowrap transition-colors disabled:opacity-40 disabled:pointer-events-none";
...
export function IconButton({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "inline-flex items-center justify-center rounded-[var(--radius)] text-ink-2 transition-colors hover:bg-bg-3 hover:text-ink",
